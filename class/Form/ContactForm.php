 ...
 * class ContactForm
 */
class ContactForm extends \Xoops\Form\ThemeForm
{
    /**
     * Maintenance Form
     */
    public function __construct()
    {
        ...
        foreach ($fields as $k => $field) {
            ...
            if (is_object($ele) && (is_subclass_of($ele, \Xoops\Form\Element::class) || is_subclass_of($ele, \Xoops\Form\TextArea::class))) {
